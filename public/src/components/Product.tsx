      ...
      <section className="product">
        <section style={{ height: "75%", width: "100%", borderRadius: "10px" }}>
          <div className="image-container">
            {imageSrc ? (
              <img className="product-image" src={imageSrc} alt="not found" />
            ) : (
              <Loader />
            )}
          </div>
          <div style={{ flexShrink: "1" }}>
            ...
            >
              ...
              {imageTitle?.length >= 50
                ? imageTitle.slice(0, 40).concat("...")
                : imageTitle}
            </p>
          </div>
        ...
        <div className="product-icons">
          ...
          <div
            ...
            onClick={() => {
              setProductInfoToggle({ toggle: true, productInfo: imageTitle });
            }}
          >
            <InfoIcon />
          </div>
